...
/*
4. Devolver la especie y la cantidad de veces que participó esa especie en un incidente, en forma descendente.
*/
...
/*
5. Devolver los incidentes del año 2020
*/
SELECT *
FROM Incidentes i
...
/*
6. Obtener los id_recinto de los recintos en estado 'Peligroso' con la cantidad de dinosaurios
...
/*
7. Obtener incidentes de tipo 'Accidente de empleado' con la especie del dinosaurio, la era de la zona y el nombre del empleado.
*/
...
/*
8. Obtener los dinosaurios de género 'Hembra' en la zona de época 'Jurásico' que estuvieron en algún incidente.
*/
...
/*
9. Obtener los nombres de dinosaurios herbívoros que pesen más de 2000 kg, ordenados ascendentemente.
*/ 
